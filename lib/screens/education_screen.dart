...
class EducationScreen extends StatefulWidget {
  ...
  const EducationScreen({super.key, required this.state});
...
class _EducationScreenState extends State<EducationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final eduSongs = state.songs.where((song) {
      final matchesCategory = song.category == 'education';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Song List View
              Expanded(
                child: eduSongs.isEmpty
                    ? Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(Icons.library_books_rounded, size: 64, color: Colors.grey.shade400),
                            const SizedBox(height: 16),
                            const Text(
                              'Lagu edukasi tidak ditemukan.',
                    ...
                    : ListView.builder(
                        itemCount: eduSongs.length,
                        itemBuilder: (context, index) {
                          final song = eduSongs[index];
                          return Card(
                            shape: RoundedRectangleBorder(
